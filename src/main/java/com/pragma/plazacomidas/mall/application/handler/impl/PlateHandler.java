...
import com.pragma.plazacomidas.mall.application.mapper.IPlateMenuMapper;
...
public class PlateHandler implements IPlateHandler {
    ...
    private final IPlateMenuMapper plateMenuMapper;
    ...
    @Override
    public List<PlateMenuResponseDto> getAllPlates(Long restaurantId, String category, int page, int size) {
        List<PlateModel> plates = plateServicePort.getAllPlates(restaurantId, category, page, size);
        return plateMenuMapper.toResponseList(plates);
    }
}
